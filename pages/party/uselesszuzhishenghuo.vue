<template>
  <view class="page">
    ...
    <!-- <view class="sele-title">
      <view class="sele-item select">党小组会</view>
      <view class="sele-item">党日制度</view>
      <view class="sele-item">党课</view>
      <view class="sele-item">党员汇报</view>
      <view class="sele-item">民主评议</view>
    </view>
    -->
		<view class="list mgt20">
      <view class="item"
            @click="goTo('msgDetail')">
